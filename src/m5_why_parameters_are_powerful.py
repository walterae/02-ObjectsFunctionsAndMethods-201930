...
def main():
    ...
    #even_better_draw_circles(rg.Point(300,10),20,15,'red',5)
    #even_better_draw_circles(rg.Point(-300, 10),8, 10, 'blue', 1)

    draw_circles(rg.Point(0, 0))
    even_better_draw_circles(rg.Point(10, 10), 5, 4, 'blue', 1)
    even_better_draw_circles(rg.Point(-10, 10), 5, 4, 'purple', 1)
    even_better_draw_circles(rg.Point(-10, -10), 5, 4, 'red', 1)
    even_better_draw_circles(rg.Point(10, -10), 5, 4, 'purple', 1)
    better_draw_circles(rg.Point(-40, 40), 4)
    better_draw_circles(rg.Point(40, 40), 4)
    better_draw_circles(rg.Point(-40,-40), 4)
    better_draw_circles(rg.Point(40, -40), 4)
    even_better_draw_circles(rg.Point(0, 0), 200, 5, 'light blue', 5)
    better_draw_circles(rg.Point(200, -225), 10)
    better_draw_circles(rg.Point(200, 225), 10)
    better_draw_circles(rg.Point(-200, -225), 10)
    better_draw_circles(rg.Point(-200, 225), 10)
    window.update()
...
def better_draw_circles(point,increase_r):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(increase_r)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(increase_r * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,increase_r,number,color,thickness):
